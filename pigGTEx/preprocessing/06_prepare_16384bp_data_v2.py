#!/usr/bin/env python3
"""
Prepare 16384bp sequence data for AlphaGenome from PigGTEx 8192bp data (v2 - Robust)
=====================================================================================
This version uses robust chromosome name normalization to handle reference genome
assembly differences and maximize variant recovery rate.

Input: piggtex_silver_benchmark_balanced.tsv (8192bp, no header)
Output: piggtex_silver_benchmark_balanced_len16384.tsv (16384bp, no header)
"""
...
OUTPUT_TSV = "/mnt/userdata4/splicing/PigGTEx/processed_data/piggtex_silver_benchmark_balanced_len16384_v2.tsv"
REFERENCE_FASTA = "/mnt/userdata4/splicing/PigGTEx/reference_genome/Sus_scrofa.Sscrofa11.1.dna.toplevel.fa"
...
def parse_variant_id(variant_id: str) -> Optional[Tuple[str, int, str, str]]:
    ...
    Expected format: chrom:pos_ref/alt (e.g., 13:65362642_C/T)
    """
...
def extend_sequences():
    ...
    logging.info("="*80)
    logging.info("AlphaGenome Data Preparation: 8192bp → 16384bp Extension (v2 - Robust)")
    logging.info("="*80)
