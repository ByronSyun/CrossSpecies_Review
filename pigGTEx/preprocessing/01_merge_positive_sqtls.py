...
def process_positive_samples():
    """
    Merge all significant sQTL files from PigGTEx project and aggregate tissue information.
    """
    ...
    logging.info("Starting Positive Sample Processing")
    ...
    logging.info("Combining data from all tissues")
    ...
    logging.info(f"Total sQTL records: {len(combined_df):,}")

    logging.info("Aggregating tissues for unique variants")
