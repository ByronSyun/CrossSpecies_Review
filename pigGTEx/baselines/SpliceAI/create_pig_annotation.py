#!/usr/bin/env python3
"""
Create SpliceAI-compatible annotation file from pig GTF.
...
def gtf_to_spliceai_annotation(gtf_path, output_path):
    """
    Convert pig GTF to SpliceAI annotation format.
    """
...
def main():
    parser = argparse.ArgumentParser(description="Convert pig GTF to SpliceAI annotation format")
    parser.add_argument('--input_gtf', required=True, help='Path to pig GTF file')
