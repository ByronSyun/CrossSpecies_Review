#!/usr/bin/env python3
"""
Evaluate SpliceTransformer Cross-Species Performance on PigGTEx
"""
...
def load_splicetransformer_vcf_results(predictions_vcf, labels_csv):
    try:
        ...
        # Attempt 1: CSV-like file (many SpliceTransformer builds output comma-separated files with a 'score' column)
        try:
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate SpliceTransformer on PigGTEx")
    default_predictions = "/Users/byronsun/Desktop/AS_复现模型/BIB_review/code/pigGTEx/baselines/spliceTransformer/SpliceTransformer_piggtex_predictions.vcf"
    default_labels = "/Users/byronsun/Desktop/AS_复现模型/BIB_review/code/pigGTEx/baselines/spliceTransformer/piggtex_labels.csv"
    default_output_dir = "/Users/byronsun/Desktop/AS_复现模型/BIB_review/code/pigGTEx/baselines/spliceTransformer"
