...
OUTPUT_FILE="evo2_pig_predictions.tsv"
BATCH_SIZE=1
...
if [ ! -f "$HOST_CURRENT_PROJECT_DIR/predict_evo2_pig.py" ]; then
    echo "ERROR: Prediction script not found: $HOST_CURRENT_PROJECT_DIR/predict_evo2_pig.py"
    exit 1
fi

HOST_DATA_DIR="/mnt/userdata4/splicing/PigGTEx/processed_data"

EVO2_COMMAND="python /app/current_project/predict_evo2_pig.py \
