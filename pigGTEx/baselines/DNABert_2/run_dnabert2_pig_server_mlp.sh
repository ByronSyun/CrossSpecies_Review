...
EMB_NPZ="$OUT_DIR/dnabert2_pig_concat_embeddings.npz"
MODEL_PATH="$OUT_DIR/dnabert2_pig_mlp_classifier.joblib"
CONF_IMG="$OUT_DIR/dnabert2_pig_mlp_confusion_matrix.png"
PROBA_TSV="$OUT_DIR/dnabert2_pig_mlp_variant_scores.tsv"
METRICS_JSON="$OUT_DIR/dnabert2_pig_mlp_metrics.json"
...
if [ -f "$EMB_NPZ" ]; then
    ...
    "${PYTHON_EXE}" "$PROJECT_DIR/predict_dnabert2_pig.py" \
...
echo ""
echo "=== DNABERT-2 MLP Pipeline Completed ==="
