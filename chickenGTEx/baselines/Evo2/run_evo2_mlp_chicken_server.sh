...
# Files
EMB_FILE="evo2_chicken_embeddings.npz"
RESULTS_DIR="results"
MODEL_FILE="$RESULTS_DIR/evo2_mlp_chicken_model.pkl"
SCALER_FILE="$RESULTS_DIR/evo2_mlp_chicken_scaler.pkl"
TRAIN_METRICS="$RESULTS_DIR/evo2_mlp_chicken_train_test_metrics.json"
EVAL_METRICS="$RESULTS_DIR/evo2_mlp_chicken_metrics.json"
PRED_TSV="$RESULTS_DIR/evo2_mlp_chicken_predictions.tsv"
PRED_METRICS_NO_PLOT="$RESULTS_DIR/evo2_mlp_chicken_metrics_noplot.json"
