#!/usr/bin/env python3
"""
Evaluate ratGTEx consolidated predictions.
...
def main():
    base = Path('/Users/byronsun/Desktop/AS_复现模型/BIB_review/code/ratGTEx/baselines')
    summary_file = base / 'ratgtex_all_model_predictions.csv'
    out_file = base / 'ratgtex_model_performance.csv'
