...
HOST_CURRENT_PROJECT_DIR="/mnt/userdata4/splicing/Evo2_rat"
HOST_BASE_PROJECT_DIR="/mnt/userdata4/splicing/Evo2Splicevardb"
HOST_INPUT_FILE="/mnt/userdata4/splicing/ratgetx/processed_data/ratgtex_silver_benchmark_balanced.tsv"
OUTPUT_FILE="evo2_rat_predictions.tsv"
BATCH_SIZE=1
...
if [ ! -f "$HOST_CURRENT_PROJECT_DIR/predict_evo2_rat.py" ]; then
    echo "ERROR: Prediction script not found: $HOST_CURRENT_PROJECT_DIR/predict_evo2_rat.py"
    exit 1
fi

HOST_DATA_DIR="/mnt/userdata4/splicing/ratgetx/processed_data"

EVO2_COMMAND="python /app/current_project/predict_evo2_rat.py \
    ...
    --input_file /app/data/ratgtex_silver_benchmark_balanced.tsv \
