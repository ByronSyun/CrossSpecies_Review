...
# Files
EMB_FILE="evo2_rat_embeddings.npz"
RESULTS_DIR="results"
MODEL_FILE="$RESULTS_DIR/evo2_mlp_rat_model.pkl"
SCALER_FILE="$RESULTS_DIR/evo2_mlp_rat_scaler.pkl"
TRAIN_METRICS="$RESULTS_DIR/evo2_mlp_rat_train_test_metrics.json"
EVAL_METRICS="$RESULTS_DIR/evo2_mlp_rat_metrics.json"
PRED_TSV="$RESULTS_DIR/evo2_mlp_rat_predictions.tsv"
PRED_METRICS_NO_PLOT="$RESULTS_DIR/evo2_mlp_rat_metrics_noplot.json"
