#!/bin/bash
# Run SpliceTransformer on ratGTEx VCF (server script)
...
INPUT_VCF="/mnt/userdata4/splicing/SpliceAI/rat_data/spliceai_input_rat.vcf"
OUTPUT_VCF="/mnt/userdata4/splicing/SpliceTransformer/data/SpliceTransformer_ratgtex_predictions.vcf"
REF_BUILD="hg38"
