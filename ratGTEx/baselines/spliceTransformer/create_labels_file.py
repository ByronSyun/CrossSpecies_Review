#!/usr/bin/env python3
"""
Create labels file for SpliceTransformer evaluation from ratGTEx TSV.
"""
...
def create_labels_file(input_tsv, output_csv):
    """
    Extract variant_id and labels from ratGTEx TSV for SpliceTransformer evaluation.
    """
    ...
    # Create labels file with variant_id and binary label
...
def main():
    parser = argparse.ArgumentParser(description="Create labels file for SpliceTransformer evaluation")
    
    parser.add_argument(
        '--input_tsv',
        type=str,
        default='/Users/byronsun/Desktop/AS_复现模型/BIB_review/data/processed_data/ratGTEx/ratgtex_silver_benchmark_balanced.tsv',
        help='Input ratGTEx TSV file'
    )
    
    parser.add_argument(
        '--output_csv',
        type=str,
        default='/Users/byronsun/Desktop/AS_复现模型/BIB_review/code/ratGTEx/baselines/spliceTransformer(need_hg38)/ratgtex_labels.csv',
